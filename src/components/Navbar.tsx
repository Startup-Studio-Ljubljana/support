			...
			<nav className="top-nav light-variant">
				<div className="flex items-center justify-between gap-[5rem]">
						...
						<li className="relative group pointer-events-none">
							...
							<ul className="absolute hidden group-hover:block bg-white rounded-3xl shadow-xl top-full p-4 min-w-[300px] sm:min-w-[360px] z-50 transition-opacity duration-300 ease-in-out">
								<li>
									...
									>
										<div className="mr-4 flex-shrink-0">
											<div className="w-16 h-16 bg-dark shadow-md rounded-xl flex items-center justify-center">
												<img src="/" alt="Porsche" className="w-10 h-10" />
											</div>
										</div>
										<div>
											<p className="font-semibold text-gray-900 text-base">
											...
											<p className="text-sm text-gray-500 mt-0.5">
												Explore the full range of luxury and sport vehicles.
											</p>
										</div>
									</a>
								</li>
								...
								<li className="mt-2">
									...
									>
										<div className="mr-4 flex-shrink-0">
											<div className="w-16 h-16 bg-[#FFDD00] shadow-md rounded-xl flex items-center justify-center">
												<img src="/" alt="Merkur" className="w-10" />
											</div>
										</div>
										<div>
											<p className="font-semibold text-gray-900 text-base">
											...
											<p className="text-sm text-gray-500 mt-0.5">
												Your partner for home, garden, and DIY projects.
											</p>
										</div>
									</a>
								</li>
								...
								<li className="mt-2">
									...
									>
										<div className="mr-4 flex-shrink-0">
											<div className="w-16 h-16 bg-dark shadow-md rounded-xl flex items-center justify-center">
												<img src="/" alt="AstroChart" className="w-10" />
											</div>
										</div>
										<div>
											<p className="font-semibold text-gray-900 text-base">
											...
											<p className="text-sm text-gray-500 mt-0.5">
												Generate and analyze detailed celestial birth charts.
											</p>
										</div>
									</a>
								</li>
								...
								<li className="mt-2">
									...
									>
										<div className="mr-4 flex-shrink-0">
											<div className="w-16 h-16 bg-white shadow-md rounded-xl flex items-center justify-center">
												<img src="/" alt="ImageFast" className="w-10 h-10" />
											</div>
										</div>
										<div>
											<p className="font-semibold text-gray-900 text-base">
											...
											<p className="text-sm text-gray-500 mt-0.5">
												Ultra-quick image hosting and sharing service.
											</p>
										</div>
									</a>
								</li>
					...
					<ul className="lg:flex hidden items-center gap-3">
						<a
							href="#contact"
							className="group relative inline-block rounded-full no-underline text-base font-medium"
						>
							<span className="absolute inset-0 rounded-full bg-black transition-all duration-300 group-hover:bg-[#2e303d]" />
							<span className="relative z-10 block text-white px-4 py-1.5">
								Get started
							</span>
						</a>
					</ul>
