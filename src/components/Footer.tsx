export default function Footer() {
  return (
    <footer id="footer" className="bg-gray-900 pt-0 lg:pt-12 relative">
      <h2 className="heading-2 hidden lg:block !text-white z-20 text-center lg:w-2/3 mx-auto !font-medium">
        Onboarding to Bauscribe will be the{" "}
        <span className="text-primary-500">easiest </span>
      ...
      <p className="text-xs text-neutral-50 mt-6 pb-8 text-center">
        Copyright Bauscribe, 2025. All rights reserved
      </p>
    </footer>
  );
}
