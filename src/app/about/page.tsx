    ...
    <div className="min-h-[100dvh]">
      <main className="flex flex-col relative">
        ...
        <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14 dark:from-indigo-950/10">
          ...
          />
          <div className="mx-auto max-w-7xl px-6 sm:pt-10 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <img
                alt="team"
                src="/assets/team.png"
                className="mt-10 aspect-[8/9] w-full rounded-2xl object-cover sm:mt-16 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 max-w-[80%] mx-auto"
              />
            </div>
          </div>
        ...
        <section className="container max-w-[76rem] mx-auto max-md:px-4 py-8">
          <h3 className="text-xl md:text-xl font-medium text-center text-gray-600 mb-4">
            Trusted by teams at:
          </h3>
          <LogoSlider small />
        </section>
